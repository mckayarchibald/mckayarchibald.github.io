...
export default function Index() {
  return (
    <div className="h-screen font-mono">
      <nav className="bg-white px-4 lg:px-6 py-2.5 dark:bg-gray-800 border-solid border-b border-gray-200">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          <div className="flex items-center">
            <span className="self-center text-l whitespace-nowrap dark:text-white font-semibold">
              McKay Archibald
            </span>
          </div>
          ...
          >
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              <li>
                <div className="block py-2 pr-4 pl-3 text-gray-700 rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 dark:text-white text-sm">
                  About
                </div>
              </li>
              <li>
